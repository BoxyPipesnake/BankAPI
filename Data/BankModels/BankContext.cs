...
//         => optionsBuilder.UseSqlServer("Server=localhost\\SQLEXPRESS;Database=Bank;Trusted_Connection=True;TrustServerCertificate=True;encrypt=false");

    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        modelBuilder.Entity<Account>(entity =>
        {
            entity.HasKey(e => e.Id).HasName("PK__Account__3214EC277FAD8FBC");
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__AccountT__3214EC270CB8460D");
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__BankTran__3214EC27280BB524");
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__Client__3214EC27ED3CF1A3");
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__Transact__3214EC27BC8F5CFA");
